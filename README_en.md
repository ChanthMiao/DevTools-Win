...
Since v1.1.2, it provides `Get-DrwConfig, Set-DtwConfig` to quickly get/set the configuration. If you need to make the changes permanent, execute the command `Show-DtwConfig|ConvertTo-Json|Out-File $Env:LOCALAPPDATA\DevTools-Win\config.json`.
